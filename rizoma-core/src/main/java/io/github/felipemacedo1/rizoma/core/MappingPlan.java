...
public record MappingPlan(String formatVersion, String planId, String engineVersion,
        ...
        String layoutTemplateId, String layoutTemplateVersion, String layoutFingerprint,
        LayoutCompatibilityReport.ExecutionRoute executionRoute,
        List<FieldMapping> mappings, List<String> ignoredSourceColumns, List<String> unmappedSourceColumns,
    ...
    public MappingPlan {
        ...
        layoutTemplateId = layoutTemplateId == null ? "" : layoutTemplateId;
        layoutTemplateVersion = layoutTemplateVersion == null ? "" : layoutTemplateVersion;
        layoutFingerprint = layoutFingerprint == null ? "" : layoutFingerprint;
        executionRoute = executionRoute == null
                ? LayoutCompatibilityReport.ExecutionRoute.FULL_ANALYSIS : executionRoute;
        mappings = List.copyOf(mappings);
        ignoredSourceColumns = List.copyOf(ignoredSourceColumns == null ? List.of() : ignoredSourceColumns);
        unmappedSourceColumns = List.copyOf(unmappedSourceColumns);
    ...
    public MappingPlan(String formatVersion, String planId, String engineVersion,
        ...
        this(formatVersion, planId, engineVersion, sourceId, sourceFingerprint, schemaId,
                ...
                NoOpMappingKnowledgeBase.SNAPSHOT_ID, "1.0", "", "", "",
                LayoutCompatibilityReport.ExecutionRoute.FULL_ANALYSIS, mappings, List.of(), unmappedSourceColumns,
                confirmedSourceColumns);
    }

    /** Backward-compatible constructor for MappingPlan 1.1 with knowledge metadata. */
    public MappingPlan(String formatVersion, String planId, String engineVersion,
            String sourceId, String sourceFingerprint, String schemaId, String schemaVersion,
            String schemaFingerprint, String configurationVersion, String configurationFingerprint,
            String knowledgeSnapshotId, String knowledgeVersion, List<FieldMapping> mappings,
            List<String> unmappedSourceColumns, List<String> confirmedSourceColumns) {
        this(formatVersion, planId, engineVersion, sourceId, sourceFingerprint, schemaId,
                schemaVersion, schemaFingerprint, configurationVersion, configurationFingerprint,
                knowledgeSnapshotId, knowledgeVersion, "", "", "",
                LayoutCompatibilityReport.ExecutionRoute.FULL_ANALYSIS, mappings, List.of(),
                unmappedSourceColumns, confirmedSourceColumns);
    }
    ...
    public record FieldMapping(String sourceColumnId, String targetFieldId,
        ...
        public FieldMapping {
            ...
            requireText(targetFieldId, "targetFieldId");
            projectionSource = projectionSource == null
                    ? ProjectionSource.sourceColumn(sourceColumnId) : projectionSource;
            if (projectionSource.kind() == ProjectionSource.Kind.SOURCE_COLUMN) {
                if (sourceColumnId.isBlank()) sourceColumnId = projectionSource.sourceColumnId();
                if (!sourceColumnId.equals(projectionSource.sourceColumnId()))
                    throw new IllegalArgumentException("legacy sourceColumnId differs from projection source");
            } else if (!sourceColumnId.isEmpty()) {
                throw new IllegalArgumentException("non-direct projection must not use legacy sourceColumnId");
            }
        ...
        /** Backward-compatible direct source-column mapping constructor. */
        public FieldMapping(String sourceColumnId, String targetFieldId,
                List<Step> transformations, List<Step> validations,
                boolean confirmed, String confirmationReason) {
            this(sourceColumnId, targetFieldId, null, transformations, validations,
                    confirmed, confirmationReason);
        }
    }
